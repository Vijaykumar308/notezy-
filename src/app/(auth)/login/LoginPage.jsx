                        ...
                        <div className="max-w-md mx-auto w-full">
                            ...
                            <form action={formAction} className="space-y-4 lg:space-y-6">
                                ...
                                <button
                                    type="submit"
                                    disabled={isPending}
                                    className="w-full bg-blue-500 text-white py-3 rounded-lg font-medium hover:bg-blue-600 transition-colors text-base disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                            ...
                            {/* Guest Login Section */}
                            <div className="mt-6 lg:mt-8 border-t pt-6">
                                <h3 className="text-sm font-medium text-gray-700 mb-4 text-center">Guest Access</h3>
                                <form action={formAction} className="space-y-4">
                                    <div>
                                        <input
                                            type="text"
                                            placeholder="Enter your name (Guest)"
                                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent outline-none text-base"
                                            name="guestName"
                                            disabled={isPending}
                                        />
                                    ...
                                    <button 
                                        type="submit"
                                        disabled={isPending}
                                        className="w-full bg-gray-100 text-gray-700 py-3 rounded-lg font-medium hover:bg-gray-200 transition-colors text-base disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
